#   -*- coding:utf-8 -*-
#   The subwindow_plot.py in FeatureAnalyzer
...
class SubWindow_Plot(MyQMdiSubWindow):
    count = 0
    def __init__(self):
        ...
        SubWindow_Plot.count += 1
        self.setWindowTitle(self.generate_title(SubWindow_Plot.count))
