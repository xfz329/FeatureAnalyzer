...
class Ui_Power_rm_anova_MainWindow(SubWindow_Pingouin):
    ...
    def set_widgets(self):
        ...
        self.desc.setdefault("brief", "power_rm_anova method!")
    ...
    def start_analyse(self):
        ...
        if corr is not None:
            if type(corr) is not float:
                ...
                corr= None
        self.paras.setdefault("corr",corr)
        ...
        if epsilon is not None:
            if type(epsilon) is not float:
                ...
                epsilon= None
        self.paras.setdefault("epsilon",epsilon)
        ...
        self.task.set_worker(pg.power_rm_anova, **self.paras)